...
const primaryServices = [
  {
    ...
    description: "Expert deal structuring with or without commercial components, ensuring optimal outcomes for all parties involved.",
  },
  {
    icon: FileText,
    title: "Contract Services",
    description: "Comprehensive contract drafting, reviewing, negotiating, and execution services tailored to your specific needs.",
  },
  {
    icon: Shield,
    title: "Policy Framework",
    description: "Setting up of comprehensive policies, frameworks, and operational manuals for your organization.",
  },
  {
    icon: SearchCheck,
    title: "Research & Opinions",
    description: "In-depth legal research and expert opinions to support your decision-making processes.",
  },
  {
    icon: MessageSquare,
    title: "Consultations & Advisory",
    description: "Strategic legal consultations and ongoing advisory services to guide your business forward.",
  },
  {
    icon: Settings,
    title: "Standards & Practices",
    description: "Establishment of legal standards and best practices tailored to your industry and organizational needs.",
  }
];
            ...
            {primaryServices.map((service, index) => (
              ...
              >
                <div className="flex items-center mb-4">
                  <div className="p-3 bg-gradient-to-br from-sage-100 to-sage-200 rounded-lg mr-4">
